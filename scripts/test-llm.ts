...
import { getLLMConfig, createLLM, LLMProvider } from "../src/config/llmConfig";
...
try {
  ...
  switch (config.provider) {
    case "openai":
      ...
      isCorrectType = llm instanceof ChatOpenAI;
      break;
    case "anthropic":
      expectedType = "ChatAnthropic";
      isCorrectType = llm instanceof ChatAnthropic;
      break;
    case "gemini":
      expectedType = "ChatGoogleGenerativeAI";
      isCorrectType = llm instanceof ChatGoogleGenerativeAI;
      break;
    default:
...
console.log("-".repeat(60));
const testProviders: LLMProvider[] = ["openai", "anthropic", "gemini"];
const apiKeyVars = {
